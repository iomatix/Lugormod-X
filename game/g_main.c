...
#define ENC_LUGORMODVERSION_CVAR "\xD1\xF4\xF4\xDB\xF8\xF3\xEC\xF2\xE4\xF7\xF4\xFA\xF7\xE9\xEA\xEE" //lugormod_version
#define ENC_GAMENAME_CVAR "\xEC\xEA\xF2\xF2\xE6\xE6\xF3\xEA" //gamename 
#define ENC_BASECHAR '{' //code
#define ENC_LUGORMOD "\xD1\xF4\xF4\xEC\xF2\xFA\xF7\xE9" //Lugormod
#define LUGORMODVERSION_CORE "\xDD\xB2\xA8" //Version
...
{ &lmd_rewardcr_kill, "lmd_rewardcr_kill", "35", CVAR_ARCHIVE, 0, qtrue, qfalse,
"Give a player credits for killing other players.  Does not work for killing NPCs.",
},
{ &lmd_rewardexp_kill, "lmd_rewardexp_kill", "45", CVAR_ARCHIVE, 0, qtrue, qfalse,
